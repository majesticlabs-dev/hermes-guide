...
- [Copy-Ready Public SOUL.md](SOUL.public.example.md) — Compact, sanitized operator profile that can be copied into a Hermes installation and adapted without exposing private runtime details.
