...
For a compact file that is ready to copy and adapt, start with [`SOUL.md`](SOUL.md). This page explains the design choices and provides additional role-specific examples.
